...
SYSTEM_PROMPT: Final[str] = _SYSTEM_PROMPT_V3
EXTRACTION_INSTRUCTIONS: Final[str] = _EXTRACTION_INSTRUCTIONS_V3
...
def build_extraction_messages(
    ...
    Args:
        ...
        prompt_version: Prompt version to use ("v1", "v2", or "v3").
    ...
    if prompt_version not in _PROMPTS:
        logger.warning(
            f"Unknown prompt version {prompt_version!r}, falling back to 'v3'"
        )
        prompt_version = "v3"
