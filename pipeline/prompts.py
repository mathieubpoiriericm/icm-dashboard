...
SYSTEM_PROMPT: Final[str] = _SYSTEM_PROMPT_V2
EXTRACTION_INSTRUCTIONS: Final[str] = _EXTRACTION_INSTRUCTIONS_V2
...
def build_extraction_messages(
    ...
    if prompt_version not in _PROMPTS:
        logger.warning(
            f"Unknown prompt version {prompt_version!r}, falling back to 'v2'"
        )
        prompt_version = "v2"
